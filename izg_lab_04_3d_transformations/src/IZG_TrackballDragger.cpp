...
IZG_TrackballDragger::IZG_TrackballDragger(bool useAutoTransform)
{
    if (useAutoTransform)
    {
        ...
        _xDragger = new IZG_RotateCylinderDragger();
        scaler->addChild(_xDragger.get());
        addDragger(_xDragger.get());

        _yDragger = new IZG_RotateCylinderDragger();
        scaler->addChild(_yDragger.get());
        addDragger(_yDragger.get());

        _zDragger = new IZG_RotateCylinderDragger();
...
IZG_TrackballDragger::~IZG_TrackballDragger()
{
}

void IZG_TrackballDragger::setupDefaultGeometry()
{
...
void IZG_TrackballDragger::setAxisLineWidth(float linePixelWidth)
{
    _axisLineWidth = linePixelWidth;
    if (_lineWidth.valid())
        _lineWidth->setWidth(linePixelWidth);
}
void IZG_TrackballDragger::setPickCylinderHeight(float pickCylinderHeight)
{
