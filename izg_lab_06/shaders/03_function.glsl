...
void createQuad(in mat4 vp){
  ...
  if(gl_VertexID==3)gl_Position = vp*vec4(0.f,1.f,0.f,1.f);
  if(gl_VertexID==4)gl_Position = vp*vec4(1.f,0.f,0.f,1.f);
  if(gl_VertexID==5)gl_Position = vp*vec4(1.f,1.f,0.f,1.f);
}
