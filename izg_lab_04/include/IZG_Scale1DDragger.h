...
namespace osgManipulator {
     ...
     */
    class IZG_Scale1DDragger : public Dragger
    {
    public:
        ...
        IZG_Scale1DDragger(ScaleMode scaleMode = SCALE_WITH_ORIGIN_AS_PIVOT);

        META_OSGMANIPULATOR_Object(osgManipulator, IZG_Scale1DDragger)
