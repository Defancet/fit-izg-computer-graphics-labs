...
namespace osgManipulator {
     ...
     */
    class IZG_Translate1DDragger : public Dragger
    {
    public:

        IZG_Translate1DDragger();

        META_OSGMANIPULATOR_Object(osgManipulator, IZG_Translate1DDragger);

        IZG_Translate1DDragger(const osg::Vec3d& s, const osg::Vec3d& e);
    ...
    protected:
        ...
        virtual ~IZG_Translate1DDragger();
